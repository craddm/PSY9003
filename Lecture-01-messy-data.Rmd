...
.pull-left[Deletion can be wasteful, throwing out a lot of otherwise good data.

And if the data is Missing Not At Random, the data is not representative of the full range of the variable of interest!]
.pull-right[
