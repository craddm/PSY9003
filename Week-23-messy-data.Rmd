...
The different transformations each have different effects on the data, but the general pattern on right-tailed data is that they (mostly) reduce the skew, bringing extreme values closer to the centre of the distribution. The transformations aren't as effective on left-tailed data.

Moral: consider alternatives to transformations... (see later!)
.pull-left[
```{r fig.height=5, echo = FALSE}
